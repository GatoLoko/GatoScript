...
def unload():
    ...
    hexchat.unhook(_RAW301)
    hexchat.unhook(_RAW307)
    hexchat.unhook(_RAW310)
    hexchat.unhook(_RAW311)
    hexchat.unhook(_RAW312)
    hexchat.unhook(_RAW313)
    hexchat.unhook(_RAW316)
    hexchat.unhook(_RAW317)
    hexchat.unhook(_RAW318)
    hexchat.unhook(_RAW319)
    hexchat.unhook(_RAW320)
    hexchat.unhook(_RAW330)
    hexchat.unhook(_RAW335)
    hexchat.unhook(_RAW337)
    hexchat.unhook(_RAW338)
    hexchat.unhook(_RAW342)
    hexchat.unhook(_RAW378)
    hexchat.unhook(_RAW379)
    hexchat.unhook(_RAW401)
    hexchat.unhook(_RAW671)
...
_RAW301 = hexchat.hook_server('301', whois_cb, userdata=None, priority=10)
# whoisregnick (Unreal)
_RAW307 = hexchat.hook_server('307', whois_cb, userdata=None, priority=10)
# whoishelpop (Unreal)
_RAW310 = hexchat.hook_server('310', whois_cb, userdata=None, priority=10)
# whoisuser (RFC1459)
_RAW311 = hexchat.hook_server('311', whois_cb, userdata=None, priority=10)
# whoisserver (RFC1459)
_RAW312 = hexchat.hook_server('312', whois_cb, userdata=None, priority=10)
# whoisoperator (RFC1459)
_RAW313 = hexchat.hook_server('313', whois_cb, userdata=None, priority=10)
# whoischanop (RFC1459)
_RAW316 = hexchat.hook_server('316', whois_cb, userdata=None, priority=10)
# whoisidle (RFC1459)
_RAW317 = hexchat.hook_server('317', whois_cb, userdata=None, priority=10)
# endofwhois (RFC1459)
_RAW318 = hexchat.hook_server('318', whois_cb, userdata=None, priority=10)
# whoischannels (RFC1459)
_RAW319 = hexchat.hook_server('319', whois_cb, userdata=None, priority=10)
# whoisspecial (Unreal)
_RAW320 = hexchat.hook_server('320', whois_cb, userdata=None, priority=10)
# whoisaccount (logged in as) (IRCU)
_RAW330 = hexchat.hook_server('330', whois_cb, userdata=None, priority=10)
# whoisbot (Unreal)
_RAW335 = hexchat.hook_server('335', whois_cb, userdata=None, priority=10)
# SSL
_RAW337 = hexchat.hook_server('337', whois_cb, userdata=None, priority=10)
# whoisactually (user@host, ip) (Unreal)
_RAW338 = hexchat.hook_server('338', whois_cb, userdata=None, priority=10)
# Only accepts querys from registered users
_RAW342 = hexchat.hook_server('342', whois_cb, userdata=None, priority=10)
# whoishost (virtual host) (Unreal)
_RAW378 = hexchat.hook_server('378', whois_cb, userdata=None, priority=10)
# whoismodes (Unreal)
_RAW379 = hexchat.hook_server('379', whois_cb, userdata=None, priority=10)
# No such nick (RFC1459)
_RAW401 = hexchat.hook_server('401', whois_cb, userdata=None, priority=10)
# whoissecure (Using SSL) (KineIRCd, ircd-seven)
_RAW671 = hexchat.hook_server('671', whois_cb, userdata=None, priority=10)
